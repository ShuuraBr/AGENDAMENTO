...
CREATE TABLE IF NOT EXISTS agendamentos (
    ...
    whatsapp_confirmacao_status        VARCHAR(20)  NULL DEFAULT NULL,
    whatsapp_confirmacao_telefone      VARCHAR(25)  NULL DEFAULT NULL,
    whatsapp_confirmacao_enviado_em    DATETIME     NULL DEFAULT NULL,
    whatsapp_confirmacao_ultimo_envio_em DATETIME   NULL DEFAULT NULL,
    whatsapp_confirmacao_tentativas    INT          NOT NULL DEFAULT 0,
    whatsapp_confirmacao_respondido_em DATETIME     NULL DEFAULT NULL,
    voucher_whatsapp_enviado           TINYINT(1)   NOT NULL DEFAULT 0,
    voucher_whatsapp_enviado_em        DATETIME     NULL DEFAULT NULL,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
