...
CREATE TABLE IF NOT EXISTS agendamentos (
    ...
    -- WhatsApp opt-in antes do envio do voucher (V14)
    -- NOTA: em produção estas colunas existem em camelCase (adicionadas antes da V14).
    -- Usar os nomes abaixo apenas em bancos novos; em produção já existe a versão camelCase.
    whatsappConfirmacaoStatus        VARCHAR(20)  NULL DEFAULT NULL,
    whatsappConfirmacaoTelefone      VARCHAR(25)  NULL DEFAULT NULL,
    whatsappConfirmacaoEnviadoEm     DATETIME     NULL DEFAULT NULL,
    whatsappConfirmacaoUltimoEnvioEm DATETIME     NULL DEFAULT NULL,
    whatsappConfirmacaoTentativas    INT          NOT NULL DEFAULT 0,
    whatsappConfirmacaoRespondidoEm  DATETIME     NULL DEFAULT NULL,
    voucherWhatsappEnviado           TINYINT(1)   NOT NULL DEFAULT 0,
    voucherWhatsappEnviadoEm         DATETIME     NULL DEFAULT NULL,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
