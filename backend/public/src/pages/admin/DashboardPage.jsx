...
export default function DashboardPage() {
  ...
  const agendamentos = useMemo(() => {
    ...
    if (search.trim()) {
      ...
      list = list.filter((a) =>
        [a.protocolo, a.fornecedor, a.transportadora, a.motorista, a.placa, a.status]
      ...
      <div style={{ background: '#fff', borderRadius: 16, padding: 20, boxShadow: '0 8px 20px rgba(15,23,42,0.06)', border: '1px solid #e5e7eb' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 10, marginBottom: 14 }}>
          ...
          <input
            ...
            placeholder="Buscar protocolo, fornecedor, transportadora..."
            style={{ padding: '8px 12px', borderRadius: 10, border: '1px solid #cbd5e1', minWidth: 280, fontSize: 13 }}
          />
        </div>
