      ...
      <div style={styles.card}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: 10, marginBottom: 16 }}>
          <div>
            ...
            <input style={{ ...styles.input, fontSize: 13 }} placeholder="Protocolo..." value={tableFilter.protocolo} onChange={(e) => setTableFilter((f) => ({ ...f, protocolo: e.target.value }))} />
          </div>
          <div>
          ...
          <div>
            ...
            <input style={{ ...styles.input, fontSize: 13 }} placeholder="Nome do fornecedor..." value={tableFilter.fornecedor} onChange={(e) => setTableFilter((f) => ({ ...f, fornecedor: e.target.value }))} />
          </div>
          <div>
            <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#475569', marginBottom: 4 }}>Transportadora</label>
            <input style={{ ...styles.input, fontSize: 13 }} placeholder="Nome da transportadora..." value={tableFilter.transportadora} onChange={(e) => setTableFilter((f) => ({ ...f, transportadora: e.target.value }))} />
          </div>
          <div>
            <label style={{ display: 'block', fontSize: 12, fontWeight: 600, color: '#475569', marginBottom: 4 }}>NF</label>
            <input style={{ ...styles.input, fontSize: 13 }} placeholder="Número da NF..." value={tableFilter.nf} onChange={(e) => setTableFilter((f) => ({ ...f, nf: e.target.value }))} />
          </div>
          <div style={{ display: 'flex', alignItems: 'flex-end' }}>
            <button type="button" onClick={() => setTableFilter({ protocolo: '', data: '', fornecedor: '', transportadora: '', nf: '' })} style={{ ...styles.secondaryButton, padding: '10px 14px', fontSize: 13, width: '100%' }}>
              Limpar filtros
            </button>
          </div>
        </div>
